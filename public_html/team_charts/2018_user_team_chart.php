...
$sql = "SELECT * FROM `user_teams` WHERE `userID` = $val AND `raceYear` = '2018'";
...
echo "<th>2018</th><th>Group A</th><th>Group B</th><th>Group C</th><th>Group D</th></tr>";

//	Segment 1

$sql = "SELECT * FROM `user_picks` WHERE `userID` = $val AND `raceYear` = '2018' AND `segment` = 'S1'";
...
$sql = "SELECT * FROM `user_picks` WHERE `userID` = $val AND `raceYear` = '2018' AND `segment` = 'S2'";
...
$sql = "SELECT * FROM `user_picks` WHERE `userID` = $val AND `raceYear` = '2018' AND `segment` = 'S3'";
...
$sql = "SELECT * FROM `user_picks` WHERE `userID` = $val AND `raceYear` = '2018' AND `segment` = 'S4'";
