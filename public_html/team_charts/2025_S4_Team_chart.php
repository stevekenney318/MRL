...
//
// 2025 Segment 4 Team Chart - change segment 99 to S to release

$sql = "SELECT * FROM `picks` WHERE `raceYear` = '2025' AND `segment` = 'S4' AND `userName` != 'MRL' ORDER BY `picks`.`userID` ASC";
...
echo "<th colspan=6>2025 Playoffs Team Chart</th>";
echo "<tr style=background-color:#fabf8f>";
