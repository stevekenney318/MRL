...
//
// 2019 Segment 3 Team Chart - change segment 99 to S3 to release

$sql = "SELECT * FROM `picks` WHERE `raceYear` = '2019' AND `segment` = 'S3' AND `userName` != 'MRL' ";
...
echo "<th colspan=6>2019 Segment 3 Team Chart</th>";
echo "<tr style=background-color:#fabf8f>";
