...
$sql = "SELECT * FROM `user_picks_history` WHERE `raceYear` = '2023' AND `teamName` != 'MRL' ORDER BY `user_picks_history`.`userID` ASC, `user_picks_history`.`segment` ASC, `user_picks_history`.`entryDate` ASC";
...
echo "<th colspan=7>2023 All Segments Team Chart</th></tr>";  // Corrected: Closed the <tr> tag here
echo "<tr style=background-color:#fabf8f>";
echo "<th>Team</th><th>Segment</th><th>Group A</th><th>Group B</th><th>Group C</th><th>Group D</th><th>Submission Time</th></tr>";
