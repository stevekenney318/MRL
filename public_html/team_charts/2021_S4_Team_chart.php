...
//
// 2021 Segment 3 Team Chart - change segment 99 to S4 to release

$sql = "SELECT * FROM `picks` WHERE `raceYear` = '2021' AND `segment` = 'S4' AND `userName` != 'MRL' ORDER BY `picks`.`userID` ASC";
...
echo "<th colspan=6>2021 Segment 4 Team Chart</th>";
echo "<tr style=background-color:#fabf8f>";
