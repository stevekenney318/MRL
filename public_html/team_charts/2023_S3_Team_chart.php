...
//
// 2023 Segment 3 Team Chart - change segment 99 to S to release

$sql = "SELECT * FROM `picks` WHERE `raceYear` = '2023' AND `segment` = 'S3' AND `userName` != 'MRL' ORDER BY `picks`.`userID` ASC";
