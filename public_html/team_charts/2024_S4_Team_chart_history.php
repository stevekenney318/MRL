...
//
// 2024 Playoffs Team Chart except MRL

$sql = "SELECT * FROM `picks_history` WHERE `raceYear` = '2024' AND `segment` = 'S4' AND `userName` != 'MRL' ORDER BY `picks_history`.`userID` ASC";
// $sql = "SELECT *  FROM `picks_history` WHERE `driverA` = '-- No Pick Yet --'";
...
echo "<th colspan=6>2024 Playoffs Team Chart</th>";
echo "<tr style=background-color:#fabf8f>";
