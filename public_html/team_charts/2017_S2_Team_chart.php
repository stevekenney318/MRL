...
//
// 2017 Segment 2 Team Chart - change segment 99 to S2 to release

$sql = "SELECT * FROM `picks` WHERE `raceYear` = '2017' AND `segment` = 'S2' AND `userName` != 'MRL' ";
...
echo "<th colspan=6>2017 Segment 2 Team Chart</th>";
echo "<tr style=background-color:#fabf8f>";
