...
//
// 2020 Segment 2 Team Chart with -- No Picks Yet --

$sql = "SELECT * FROM `picks` WHERE `raceYear` = '2020' AND `segment` = 'S2' AND `driverA` = '-- No Pick Yet --' AND `userName` != 'MRL' ";
...
echo "<th colspan=6>2020 Segment 2 Team Chart</th>";
echo "<tr style=background-color:#fabf8f>";
