...
<body>
    <h1>2025 Fees & Payment</h1>
    <p><span class="section-text">Fees:</span></p>
    <ul>
        <!-- <li style="list-style-type: none;">For 2025, the Fee is <span style="color: White;">$45.60</span> per Race Team:</li> -->
        <li style="list-style-type: none;">For 2025, the Fee is <span style="color: Red;">$50.00</span> per Race Team:</li>
        <br>
        <img src="https://manliusracingleague.com/wp-content/uploads/2025/02/2025-Fees-dark-20250218.231630393.jpg" alt="2024 Fees" style="width: 50%; margin-bottom: 20px;">
        <li style="list-style-type: none;">Here is the <a href="https://manliusracingleague.com/wp-content/uploads/2025/02/2025-Payouts.pdf" target="_blank">Payout structure chart</a> for 2025.</li>
        <br>
        <li style="list-style-type: none;">And here are the invoices for the website cost – 3yr <a href="https://manliusracingleague.com/wp-content/uploads/2023/03/Hostwinds-3-yr-Hosting-Invoice-3009803.pdf" target="_blank">hosting fee</a> (split cost over 2023, 2024 & 2025) and 1 yr <a href="https://manliusracingleague.com/wp-content/uploads/2025/01/Hostwinds-1-yr-Domain-Name-Registration-2025-Invoice-3769709.pdf" target="_blank">domain name fee</a> (invoiced each year).</li>
...
if ($result && $result->rowCount() > 0) {
    foreach ($result as $row) {
        echo "<tr><td style=width:14%;background-color:#b7dee8>" . 'Paid Status ' . 2025 . "</td><td style=background-color:#b7dee8>" . $row['paidStatus'] . "</td></tr>";
...
?>
        <br><br><br><br>
        <li style="list-style-type: none;">Payment is due by Friday April 4, 2025</li>
