...
/*
    filename: admin_backup_db_helper.php
...
if ($didPostAction) {
    ...
    header('Location: admin_backup.php?section=db');
    exit;
}
...
<head>
<meta charset="utf-8">
<title>MRL Backup Manager - Database</title>
...
<div class="wrap">
    ...
    <div class="card">
        ...
        <div class="row" style="margin-top:8px !important;">
            <a class="btn btn-secondary" href="admin_backup.php">Backup Manager Home</a>
            <a class="btn btn-primary" href="admin_backup.php?section=files">Files Backup</a>
        </div>
        <p class="sub">
    ...
    <div style="font-size:10px; color:#999; text-align:right; margin:14px 10px 8px 10px; padding:0;">
        admin_backup_db_helper.php (via admin_backup.php)
    </div>
