...
function atpc_rows(string $key, array $items): void
{
    foreach ($items as $i => $it) {
        echo '<tr>';
        echo '<td class="order"><button type="button" class="mini" onclick="moveRow(this,-1)">↑</button><button type="button" class="mini" onclick="moveRow(this,1)">↓</button></td>';
...
<div class="card"><h1>Manage Team Page Content</h1><p><a href="/team_redesign.php">← Team Redesign</a></p>
...
<p>Use ↑ / ↓ to reorder.</p><button type="button" onclick="addRow('<?php echo atpc_h($key);?>')">Add Link</button>
</div><?php endforeach;?>
