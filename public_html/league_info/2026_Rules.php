...
<body>
    ...
    <ul>
        ...
        <li>The final segment is the “The Chase” and will consist of 10 races.</li>
    </ul>
    ...
    <ul>
        <li>Prior to making your selection of drivers for Segment 1, you will need to set your Team Name for the year. You will have multiple options: Choose the team name from your previous year; choose a team name you have used in any of the years you have participated; or choose a brand new unique team name.</li>       
    ...
    <ul>
        ...
        <li>You DO NOT receive the “adjustment” points awarded during The Chase format.</li>
    </ul>
    ...
    <ul>
        ...
        <li>9 segment winners (1st & 2nd place for S1-S3, and 1st, 2nd & 3rd place for The Chase)</li>
