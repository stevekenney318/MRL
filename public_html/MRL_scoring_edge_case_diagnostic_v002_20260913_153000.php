 ...
 *
 * v002:
 * - FIX: Removed PHP 7.4+ arrow-function syntax so the diagnostic is compatible with PHP 7.3.
 *
 * READ ONLY:
...
<title>MRL Scoring Edge-Case Diagnostic v002</title>
<style>
...
<body><div class="wrap">
<div class="panel">
<h1>MRL Scoring Edge-Case Diagnostic v002</h1>
<div class="meta">Generated 9/13/2026 3:16:42 pm ET · READ ONLY · No DB writes · No file writes</div>
<div class="meta">Scope: <?=diag_h($year)?> <?=diag_h($segment)?> · races <?php $raceLabels=[]; foreach($races as $n){$raceLabels[]='R'.str_pad((string)$n,2,'0',STR_PAD_LEFT);} echo diag_h(implode(', ', $raceLabels)); ?></div>
</div>
