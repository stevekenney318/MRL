...
$sql = "SELECT * FROM `user_picks_history` WHERE `userID` = $uid AND `raceYear` = $raceYear AND `segment` = 'S1'";
...
$sql = "SELECT * FROM `user_picks_history` WHERE `userID` = $uid AND `raceYear` = $raceYear AND `segment` = 'S2'";
...
$sql = "SELECT * FROM `user_picks_history` WHERE `userID` = $uid AND `raceYear` = $raceYear AND `segment` = 'S3'";
...
$sql = "SELECT * FROM `user_picks_history` WHERE `userID` = $uid AND `raceYear` = $raceYear AND `segment` = 'S4'";
