 ...
 *
 * VERSION: v003
 * LAST MODIFIED: 8/30/2026 7:51:29 am
 *
 * PURPOSE:
...
$backupRoot = $root . '/_migration_backups/userid_0_to_999_application_safeguards_20260830_075129am';
...
$targets = [
    ...
    [
        ...
        'replacements' => [
            [
                'find' => '$sql_submitted = "SELECT * FROM `user_picks` WHERE `raceYear` = \'$raceYear\' AND `userID` != \'0\' AND `segment` = \'$segment\' ORDER BY `entryDate` ASC";',
                'replace' => '$sql_submitted = "SELECT * FROM `user_picks` WHERE `raceYear` = \'$raceYear\' AND `userID` NOT IN (0, 999) AND `segment` = \'$segment\' ORDER BY `entryDate` ASC";',
                'expected' => 1,
            ],
            [
                'find' => '$notSubmitted = "SELECT `teamName` FROM `user_picks` WHERE `raceYear` = \'$raceYear\' AND `segment` = \'$compareSegment\' AND `userID` != \'0\' AND `teamName` NOT IN ( SELECT `teamName` FROM `user_picks` WHERE `raceYear` = \'$raceYear\' AND `segment` = \'$segment\' )";',
                'replace' => '$notSubmitted = "SELECT `teamName` FROM `user_picks` WHERE `raceYear` = \'$raceYear\' AND `segment` = \'$compareSegment\' AND `userID` NOT IN (0, 999) AND `teamName` NOT IN ( SELECT `teamName` FROM `user_picks` WHERE `raceYear` = \'$raceYear\' AND `segment` = \'$segment\' )";',
                'expected' => 1,
            ],
        ],
    ],
...
<div class="card">
    ...
    <p><strong>Installer:</strong> v003 &nbsp; | &nbsp; <strong>Generated:</strong> 8/30/2026 7:51:29 am America/New_York</p>
