...
/**
 * MRL_install_team_user_menu_restore_v001.php
 *
 * PURPOSE
 * -------
 * Restore the Team page account dropdown to the known-working v047 behavior
 * after the v048 portal experiment caused the dropdown to disappear.
 *
 * INSTALLS
 * --------
 * - team.php v048 -> v049
 * - Removes the body-level portal CSS/JS added in v048.
 * - Restores the original v047 open/close behavior.
 * - Keeps the v047 z-index values in place.
 * - No DB, pick/scoring, scheduler, theme, or menu-content changes.
 *
 * SAFETY
 * ------
 * - Exact v048 preflight signatures.
 * - Timestamped backup.
 * - Atomic write.
...
$generated = '9/13/2026 7:57:16 am ET';
...
if ($readable) {
    $checks = [
        ...
        ['mrl-rd-user-menu-portal', 5, 'v048 portal marker'],
...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['install'])) {
    if (!$canInstall) {
        ...
        try {
            ...
            $newSource = replace_exact(
                $newSource,
                preg_match('/\* LAST MODIFIED: .*$/m', $newSource, $m) ? $m[0] : '',
                '* LAST MODIFIED: 9/13/2026 7:57:16 am',
                1,
                'Last modified'
            );
...
<title>MRL Team User Menu Restore v001</title>
<style>
:root{
    color-scheme:dark;
...
<div class="panel">
    <h1>MRL Team User Menu Restore v001</h1>
    <p>Generated <?= h($generated) ?> · Restore known-working menu behavior · No DB writes</p>
</div>

<div class="panel">
    <h2>What this installs</h2>
    <ul>
        <li>Updates <code>team.php</code> v048 → v049.</li>
        <li>Removes the v048 body-level dropdown portal experiment.</li>
        <li>Restores the known-working v047 account-menu behavior.</li>
        <li>Keeps the v047 stacking values for later diagnosis.</li>
        <li>No pick/scoring, scheduler, theme, menu-content, or database changes.</li>
    </ul>
</div>
...
<div class="panel">
    <p class="pass">Done. Reload Team page and confirm the account menu is visible again.</p>
</div>
