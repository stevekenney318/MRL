...
<div class="card"><h1>MRL Pick Reminder Dashboard</h1><div class="muted">VERSION v004 | Admin-only | Safe default: MANUAL + TEST (MRL ID 999 only)</div><?php if($msg!==''):?><div class="banner <?php echo $msgClass==='ok'?'ok':($msgClass==='bad'?'bad':'info');?>"><?php echo mrlpr_h($msg);?></div><?php endif;?></div>
    ...
    <div class="stat">
        ...
        <div class="test-fields">
            <div>
                ...
                <input type="text" name="test_auto_date" value="<?php echo mrlpr_h($testDateValue); ?>" placeholder="MM/DD/YYYY">
            </div>
            <div>
                <label class="small">Time</label>
                <input type="text" name="test_auto_time" value="<?php echo mrlpr_h($testTimeValue); ?>" placeholder="HH:MM AM">
            </div>
        </div>
        <p class="small">When no test has been saved, these start at the current ET date/time. Usually you only need to change the minutes.</p>
    </div>
</div>
<?php
...
<div class="small" style="text-align:right">pick_reminder_dashboard.php | VERSION v004</div></div></body></html>
