 ...
 *
 * VERSION: v002
 * LAST MODIFIED: 8/30/2026 9:18:28 am
 *
 * PURPOSE:
...
function s_should_skip_dir(string $name): bool
{
    ...
    // All migration backup trees are historical artifacts, never live code.
    if ($n === '_migration_backups' || strpos($n, '_migration_backups') !== false) {
        return true;
    }
...
foreach ($it as $fileInfo) {
    ...
    // Belt-and-suspenders exclusion: never list anything from migration backup trees.
    if (preg_match('#(?:^|/)_migration_backups(?:/|$)#i', s_norm_path($rel))) {
        $skippedFiles++;
        continue;
    }
...
<p><strong>Version:</strong> v002 &nbsp; | &nbsp; <strong>Generated:</strong> 8/30/2026 9:18:28 am America/New_York</p>
...
<h2>Scope Notes</h2>
<p>
This scan deliberately ignores obvious installers, repair utilities, ALL <code>_migration_backups</code> trees, backups, archives, TESTPHP8 remnants,
