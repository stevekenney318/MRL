 ...
 *
 * VERSION: v001
 * LAST MODIFIED: 8/31/2026 2:38:17 am
 *
 * PURPOSE:
...
if (isset($_GET['export']) && $_GET['export'] === 'json') {
    ...
    if (!is_string($json)) {
        ...
        exit('Could not generate JSON report.');
    }
...
<p><strong>VERSION:</strong> v001 &nbsp; | &nbsp; <strong>Generated:</strong> <?php echo apsa_h(date('n/j/Y g:i:s a')); ?> America/New_York</p>
<div class="note">
