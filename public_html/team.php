...
$teamPageContentDefaults = [
    ...
    'league_panel' => [
        ...
        'items' => [
            ['label' => '{year} Fees & Payment Info', 'url' => '/league_info/{year}_Fees.php', 'enabled' => true, 'new_tab' => true],
            ['label' => '{year} Rules', 'url' => '/league_info/{year}_Rules.php', 'enabled' => true, 'new_tab' => true],
