...
/**
 * install_admin_db_backup_manager_v001.php
 *
 * VERSION: v001
 * LAST MODIFIED: 8/28/2026 11:11:06 pm
 *
 * PURPOSE:
 ...
 *
 * SAFETY:
 * - exact Git blob SHA-1 gate for the current production v1.4 file
...
const BASE_GIT_BLOB_SHA1 = 'e0bd42075f0ba801012f3b5d9782de244cf142d1';
...
function build_v15(string $source, array &$log): ?string {
    ...
    $new = "    v1.4  (2026-02-21)  changed time zone +00:00 to SYSTEM\n\n"
         . "    v1.5  (8/28/2026 11:11:06 pm)  Safer backup file manager.\n"
         . "                       - Active / Archive / To Be Deleted areas\n"
...
$replacementOk =
    ...
    && strpos($replacement, 'v1.5  (8/28/2026 11:11:06 pm)') !== false
...
if ($apply && $preflightOk) {
    ...
    if ($ok) {
        ...
        $checks = [
            'v1.5 version history' => strpos($installed, 'v1.5  (8/28/2026 11:11:06 pm)') !== false,
...
<head>
<meta charset="utf-8">
<title>Install Admin DB Backup Manager v1.5</title>
<style>
